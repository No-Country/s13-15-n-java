...
const ContactUs = () => {
  return (
    <div className="flex flex-col items-center">
        <div className="mt-40 text-7xl font-semibold text-center leading-[70.35px] text-cyan-950 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
          Contacto
        </div>
        <div className="mt-8 text-base font-medium leading-6 text-center text-stone-900 w-[625px] max-md:max-w-full">
